...
import {signJwt,verifyJwt} from '../utils/jwtoken.js'
...
const login = async (req,res)=>{
    ...
    if(comparePwd){ 
        const token         = signJwt({payload:tokenPayload,expiresIn:'45min'}) 
...
const authenticationController = {login,refreshToken}
